...
수집 노이즈가 많으면 최소 점수를 올립니다.

```powershell
python collect_telegram.py --limit 100 --min-score 4
```

앱에서도 사이드바의 **관심글 최소 점수**로 표시 범위를 조절할 수 있습니다. 기본값은 3입니다.
...
- `관심글` 탭: AI 인프라/메모리 투자 프레임과 관련성이 높은 글만 별도 표시
